...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-bg-primary bg-light">
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <h1 style="color: blue; text-align:center; margin-top: 20px; font-style: italic"><?php echo $document_name." Application Form"; ?></h1>
            <?php
            ...
            ?>    
                ...
                <span style="font-size: small; color: red;">Upload Jpeg Format Images and size should be less than 5MB</span>
            <?php
            ...
            ?>
                <button type="submit" name="apply_document" class="btn btn-primary" style="background-color: blue; margin-bottom: 70px;">Apply for Verification</button>
            </form>
    </body>
</html>