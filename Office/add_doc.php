...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-bg-primary bg-light">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <a class="nav-item nav-link active" href="master_panel.php">Master Panel</a>
                    <?php  } ?>
        ...
        ?>
        <h1 style="color:blue; text-align:center; margin-top: 20px; font-style: italic">Setup Document</h1>
        <form method="POST" action="server.php" style="width: 500px; margin: auto; margin-top: 20px">
                    <input type="hidden" name="id" value = "<?php echo $id; ?>" required>
                    <div class="form-group">
                        <label for="name">Name:</label>
                        <input type="text" id="name" name="name" class="form-control" pattern="[A-Za-z0-9 ]{2,50}" value= "<?php echo $name; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="desc">Description:</label>
                        <input type="text" id="desc" name="description" class="form-control" pattern="[A-Za-z0-9 ]{2,50}" value= "<?php echo $description; ?>" required>
                    </div>
                    <?php
