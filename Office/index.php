...
<html> 
    ...
    <body>
        ...
        <h1 style="color: blue; text-align:center; margin-top: 20px; font-style: italic">Sign Up</h1>
        <form method="POST" action="server.php" name="form" style="width: 500px; margin: auto; margin-top: 20px" onsubmit="return validate()">
        <div class="row">
            <div class="col">
