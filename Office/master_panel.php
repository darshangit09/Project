...
<head>
    ...
    <style>
        ...
        <body>
            <nav class="navbar navbar-expand-lg navbar-bg-primary bg-light">
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        ...
                        <a class="nav-item nav-link active" href="master_panel.php">Master Panel <span class="sr-only">(current)</span></a>
                        <?php  } ?>
            ...
            <h1 style="color: blue; text-align:center; margin-top: 20px; font-style: italic">Master User Panel</h1>
